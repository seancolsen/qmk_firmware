...
const uint16_t PROGMEM i_quot_1_combo[] = {KC_I, KC_QUOT, COMBO_END};
const uint16_t PROGMEM i_quot_2_combo[] = {KC_ASTR, KC_GRV, COMBO_END};
...
const uint16_t PROGMEM r_x_1_combo[] = {KC_R, KC_X, COMBO_END};
const uint16_t PROGMEM r_x_2_combo[] = {KC_RCBR, KC_GT, COMBO_END};
...
const uint16_t PROGMEM s_x_1_combo[] = {KC_S, KC_X, COMBO_END};
const uint16_t PROGMEM s_x_2_combo[] = {KC_LPRN, KC_GT, COMBO_END};
...
combo_t key_combos[COMBO_COUNT] = {
  ...
  [COMBO_d_b_1] = COMBO(d_b_1_combo, KC_VOLU),
  [COMBO_d_b_2] = COMBO(d_b_2_combo, KC_VOLU),
  [COMBO_dot_quot_1] = COMBO_ACTION(dot_quot_1_combo),
  [COMBO_dot_quot_2] = COMBO_ACTION(dot_quot_2_combo),
  ...
  [COMBO_h_k_1] = COMBO(h_k_1_combo, KC_BRID),
  [COMBO_h_k_2] = COMBO(h_k_2_combo, KC_BRID),
  ...
  [COMBO_i_quot_1] = COMBO_ACTION(i_quot_1_combo),
  [COMBO_i_quot_2] = COMBO_ACTION(i_quot_2_combo),
  ...
  [COMBO_n_m_1] = COMBO(n_m_1_combo, KC_BRIU),
  [COMBO_n_m_2] = COMBO(n_m_2_combo, KC_BRIU),
  ...
  [COMBO_r_x_1] = COMBO(r_x_1_combo, KC_F11),
  [COMBO_r_x_2] = COMBO(r_x_2_combo, KC_F11),
  ...
  [COMBO_t_v_2] = COMBO(t_v_2_combo, KC_VOLD),
  ...
  [COMBO_y_excl_1] = COMBO(y_excl_1_combo, KC_INS),
  [COMBO_y_excl_2] = COMBO(y_excl_2_combo, KC_INS),
  ...
  [COMBO_z_x_1] = COMBO(z_x_1_combo, KC_AT),
  [COMBO_z_x_2] = COMBO(z_x_2_combo, KC_AT),
...
void process_combo_event(uint8_t combo_index, bool p) {
  switch(combo_index) {
    ...
    case COMBO_dot_quot_2: if (p) {SEND_STRING(SS_DOWN(X_LCTL)SS_DOWN(X_DEL));} else {SEND_STRING(SS_UP(X_DEL)SS_UP(X_LCTL));} break;
    ...
    case COMBO_excl_i_1: if (p) {SEND_STRING(SS_TAP(X_END) SS_DOWN(X_LSFT)SS_TAP(X_HOME)SS_UP(X_LSFT)SS_LCTL("c")SS_TAP(X_HOME)SS_TAP(X_ENT)SS_TAP(X_LEFT)SS_LCTL("v"));}  break;
    case COMBO_excl_i_2: if (p) {SEND_STRING(SS_TAP(X_END) SS_DOWN(X_LSFT)SS_TAP(X_HOME)SS_UP(X_LSFT)SS_LCTL("c")SS_TAP(X_HOME)SS_TAP(X_ENT)SS_TAP(X_LEFT)SS_LCTL("v"));}  break;
    ...
    case COMBO_i_quot_1: if (p) {SEND_STRING(SS_TAP(X_END)SS_TAP(X_DEL));}  break;
    case COMBO_i_quot_2: if (p) {SEND_STRING(SS_TAP(X_END)SS_TAP(X_DEL));}  break;
    ...
    case COMBO_s_x_1: if (p) {SEND_STRING(SS_LCTL("ac"));}  break;
    ...
    case COMBO_x_v_2: if (p) {SEND_STRING(SS_LCTL("ax"));}  break;
