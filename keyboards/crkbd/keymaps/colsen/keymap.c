...
const uint16_t PROGMEM d_d_1_combo[] = {KC_D, KC_D, COMBO_END};
const uint16_t PROGMEM d_d_2_combo[] = {KC_DLR, KC_DLR, COMBO_END};
...
const uint16_t PROGMEM excl_o_1_combo[] = {CC_EMQM, KC_O, COMBO_END};
const uint16_t PROGMEM excl_o_2_combo[] = {KC_9, KC_PLUS, COMBO_END};
...
const uint16_t PROGMEM j_l_u_1_combo[] = {KC_J, KC_L, KC_U, COMBO_END};
const uint16_t PROGMEM j_l_u_2_combo[] = {KC_5, KC_6, KC_7, COMBO_END};
const uint16_t PROGMEM k_m_1_combo[] = {KC_K, KC_M, COMBO_END};
const uint16_t PROGMEM k_m_2_combo[] = {KC_CIRC, KC_BSLS, COMBO_END};
const uint16_t PROGMEM k_m_coma_1_combo[] = {KC_K, KC_M, CC_COSC, COMBO_END};
const uint16_t PROGMEM k_m_coma_2_combo[] = {KC_CIRC, KC_BSLS, KC_SLSH, COMBO_END};
const uint16_t PROGMEM l_e_1_combo[] = {KC_L, KC_E, COMBO_END};
const uint16_t PROGMEM l_e_2_combo[] = {KC_6, KC_EQL, COMBO_END};
...
combo_t key_combos[COMBO_COUNT] = {
  ...
  [COMBO_d_d_1] = COMBO(d_d_1_combo, KC_MPLY),
  [COMBO_d_d_2] = COMBO(d_d_2_combo, KC_MPLY),
  ...
  [COMBO_excl_o_1] = COMBO(excl_o_1_combo, KC_F9),
  [COMBO_excl_o_2] = COMBO(excl_o_2_combo, KC_F9),
  ...
  [COMBO_j_l_u_1] = COMBO_ACTION(j_l_u_1_combo),
  [COMBO_j_l_u_2] = COMBO_ACTION(j_l_u_2_combo),
  [COMBO_k_m_1] = COMBO(k_m_1_combo, KC_APP),
  [COMBO_k_m_2] = COMBO(k_m_2_combo, KC_APP),
  [COMBO_k_m_coma_1] = COMBO_ACTION(k_m_coma_1_combo),
  [COMBO_k_m_coma_2] = COMBO_ACTION(k_m_coma_2_combo),
  [COMBO_l_e_1] = COMBO(l_e_1_combo, KC_F6),
  [COMBO_l_e_2] = COMBO(l_e_2_combo, KC_F6),
  ...
  [COMBO_u_I_1] = COMBO(u_I_1_combo, KC_F7),
  [COMBO_u_I_2] = COMBO(u_I_2_combo, KC_F7),
  ...
  [COMBO_y_o_1] = COMBO(y_o_1_combo, KC_F8),
  [COMBO_y_o_2] = COMBO(y_o_2_combo, KC_F8),
...
void process_combo_event(uint8_t combo_index, bool p) {
  switch(combo_index) {
    ...
    case COMBO_j_l_u_1: if (p) {SEND_STRING(SS_TAP(X_HOME)SS_TAP(X_BSPC));}  break;
    case COMBO_j_l_u_2: if (p) {SEND_STRING(SS_TAP(X_HOME)SS_TAP(X_BSPC));}  break;
    case COMBO_k_m_coma_1: if (p) {SEND_STRING(SS_TAP(X_END)SS_TAP(X_DEL));}  break;
    case COMBO_k_m_coma_2: if (p) {SEND_STRING(SS_TAP(X_END)SS_TAP(X_DEL));}  break;
