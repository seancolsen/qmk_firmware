...
const uint16_t PROGMEM coma_dot_1_combo[] = {CC_COSC, CC_PDCL, COMBO_END};
const uint16_t PROGMEM coma_dot_2_combo[] = {KC_SLSH, CC_PDCL, COMBO_END};
const uint16_t PROGMEM d_b_1_combo[] = {KC_D, KC_B, COMBO_END};
const uint16_t PROGMEM d_b_2_combo[] = {KC_DLR, KC_PERC, COMBO_END};
const uint16_t PROGMEM dot_quot_1_combo[] = {CC_PDCL, KC_QUOT, COMBO_END};
const uint16_t PROGMEM dot_quot_2_combo[] = {CC_PDCL, KC_GRV, COMBO_END};
const uint16_t PROGMEM e_dot_1_combo[] = {KC_E, CC_PDCL, COMBO_END};
const uint16_t PROGMEM e_dot_2_combo[] = {KC_EQL, CC_PDCL, COMBO_END};
...
const uint16_t PROGMEM g_t_1_combo[] = {KC_G, KC_T, COMBO_END};
const uint16_t PROGMEM g_t_2_combo[] = {KC_4, KC_RPRN, COMBO_END};
...
const uint16_t PROGMEM m_coma_1_combo[] = {KC_M, CC_COSC, COMBO_END};
const uint16_t PROGMEM m_coma_2_combo[] = {KC_BSLS, KC_SLSH, COMBO_END};
const uint16_t PROGMEM m_coma_dot_1_combo[] = {KC_M, CC_COSC, CC_PDCL, COMBO_END};
const uint16_t PROGMEM m_coma_dot_2_combo[] = {KC_BSLS, KC_SLSH, CC_PDCL, COMBO_END};
...
const uint16_t PROGMEM n_u_i_1_combo[] = {KC_N, KC_U, KC_I, COMBO_END};
const uint16_t PROGMEM n_u_i_2_combo[] = {KC_MINS, KC_7, KC_ASTR, COMBO_END};
const uint16_t PROGMEM p_g_1_combo[] = {KC_P, KC_G, COMBO_END};
const uint16_t PROGMEM p_g_2_combo[] = {KC_3, KC_4, COMBO_END};
const uint16_t PROGMEM p_s_1_combo[] = {KC_P, KC_S, COMBO_END};
const uint16_t PROGMEM p_s_2_combo[] = {KC_3, KC_LPRN, COMBO_END};
...
const uint16_t PROGMEM r_f_t_1_combo[] = {KC_R, KC_F, KC_T, COMBO_END};
const uint16_t PROGMEM r_f_t_2_combo[] = {KC_RCBR, KC_2, KC_RPRN, COMBO_END};
...
const uint16_t PROGMEM r_z_1_combo[] = {KC_R, KC_Z, COMBO_END};
const uint16_t PROGMEM r_z_2_combo[] = {KC_RCBR, KC_LT, COMBO_END};
const uint16_t PROGMEM s_t_1_combo[] = {KC_S, KC_T, COMBO_END};
const uint16_t PROGMEM s_t_2_combo[] = {KC_LPRN, KC_RPRN, COMBO_END};
const uint16_t PROGMEM s_t_d_1_combo[] = {KC_S, KC_T, KC_D, COMBO_END};
const uint16_t PROGMEM s_t_d_2_combo[] = {KC_LPRN, KC_RPRN, KC_DLR, COMBO_END};
...
const uint16_t PROGMEM z_x_1_combo[] = {KC_Z, KC_X, COMBO_END};
const uint16_t PROGMEM z_x_2_combo[] = {KC_LT, KC_GT, COMBO_END};
...
combo_t key_combos[COMBO_COUNT] = {
  ...
  [COMBO_dot_quot_1] = COMBO(dot_quot_1_combo, KC_BRID),
  [COMBO_dot_quot_2] = COMBO(dot_quot_2_combo, KC_BRID),
  [COMBO_e_dot_1] = COMBO(e_dot_1_combo, KC_BSLASH),
  [COMBO_e_dot_2] = COMBO(e_dot_2_combo, KC_BSLASH),
  [COMBO_e_i_1] = COMBO(e_i_1_combo, KC_RGHT),
  [COMBO_e_i_2] = COMBO(e_i_2_combo, KC_RGHT),
  [COMBO_e_m_1] = COMBO(e_m_1_combo, KC_MINS),
  [COMBO_e_m_2] = COMBO(e_m_2_combo, KC_MINS),
  [COMBO_e_o_1] = COMBO(e_o_1_combo, KC_END),
  [COMBO_e_o_2] = COMBO(e_o_2_combo, KC_END),
  [COMBO_excl_i_1] = COMBO(excl_i_1_combo, KC_F9),
  [COMBO_excl_i_2] = COMBO(excl_i_2_combo, KC_F9),
  [COMBO_f_p_1] = COMBO(f_p_1_combo, KC_INS),
  [COMBO_f_p_2] = COMBO(f_p_2_combo, KC_INS),
  [COMBO_f_r_1] = COMBO(f_r_1_combo, KC_F2),
  [COMBO_f_r_2] = COMBO(f_r_2_combo, KC_F2),
  [COMBO_f_s_1] = COMBO(f_s_1_combo, KC_BSPC),
  [COMBO_f_s_2] = COMBO(f_s_2_combo, KC_BSPC),
  [COMBO_f_t_1] = COMBO(f_t_1_combo, KC_F12),
  [COMBO_f_t_2] = COMBO(f_t_2_combo, KC_F12),
  [COMBO_g_d_1] = COMBO_ACTION(g_d_1_combo),
  [COMBO_g_d_2] = COMBO_ACTION(g_d_2_combo),
  [COMBO_g_t_1] = COMBO(g_t_1_combo, KC_F4),
  [COMBO_g_t_2] = COMBO(g_t_2_combo, KC_F4),
  ...
  [COMBO_i_coma_1] = COMBO(i_coma_1_combo, KC_SLASH),
  [COMBO_i_coma_2] = COMBO(i_coma_2_combo, KC_SLASH),
  ...
  [COMBO_j_l_1] = COMBO(j_l_1_combo, KC_F5),
  [COMBO_j_l_2] = COMBO(j_l_2_combo, KC_F5),
  [COMBO_k_m_1] = COMBO(k_m_1_combo, KC_APP),
  [COMBO_k_m_2] = COMBO(k_m_2_combo, KC_APP),
  [COMBO_l_h_1] = COMBO(l_h_1_combo, KC_F6),
  [COMBO_l_h_2] = COMBO(l_h_2_combo, KC_F6),
  [COMBO_l_n_1] = COMBO(l_n_1_combo, KC_BSPC),
  [COMBO_l_n_2] = COMBO(l_n_2_combo, KC_BSPC),
  [COMBO_l_u_1] = COMBO_ACTION(l_u_1_combo),
  [COMBO_l_u_2] = COMBO_ACTION(l_u_2_combo),
  ...
  [COMBO_m_coma_dot_1] = COMBO(m_coma_dot_1_combo, KC_PGDN),
  [COMBO_m_coma_dot_2] = COMBO(m_coma_dot_2_combo, KC_PGDN),
  ...
  [COMBO_n_e_i_1] = COMBO(n_e_i_1_combo, KC_DOWN),
  [COMBO_n_e_i_2] = COMBO(n_e_i_2_combo, KC_DOWN),
  ...
  [COMBO_n_u_i_1] = COMBO(n_u_i_1_combo, KC_UP),
  [COMBO_n_u_i_2] = COMBO(n_u_i_2_combo, KC_UP),
  [COMBO_p_g_1] = COMBO(p_g_1_combo, KC_VOLU),
  [COMBO_p_g_2] = COMBO(p_g_2_combo, KC_VOLU),
  [COMBO_p_s_1] = COMBO(p_s_1_combo, KC_F3),
  [COMBO_p_s_2] = COMBO(p_s_2_combo, KC_F3),
  ...
  [COMBO_q_w_1] = COMBO(q_w_1_combo, KC_BRK),
  [COMBO_q_w_2] = COMBO(q_w_2_combo, KC_BRK),
  [COMBO_r_f_t_1] = COMBO(r_f_t_1_combo, KC_UP),
  [COMBO_r_f_t_2] = COMBO(r_f_t_2_combo, KC_UP),
  [COMBO_r_s_1] = COMBO(r_s_1_combo, KC_LEFT),
  [COMBO_r_s_2] = COMBO(r_s_2_combo, KC_LEFT),
  [COMBO_r_s_t_1] = COMBO(r_s_t_1_combo, KC_DOWN),
  [COMBO_r_s_t_2] = COMBO(r_s_t_2_combo, KC_DOWN),
  [COMBO_r_t_1] = COMBO(r_t_1_combo, KC_END),
  [COMBO_r_t_2] = COMBO(r_t_2_combo, KC_END),
  [COMBO_r_z_1] = COMBO_ACTION(r_z_1_combo),
  [COMBO_r_z_2] = COMBO_ACTION(r_z_2_combo),
  [COMBO_s_t_1] = COMBO(s_t_1_combo, KC_RGHT),
  [COMBO_s_t_2] = COMBO(s_t_2_combo, KC_RGHT),
  [COMBO_s_t_d_1] = COMBO(s_t_d_1_combo, KC_MPLY),
  [COMBO_s_t_d_2] = COMBO(s_t_d_2_combo, KC_MPLY),
  [COMBO_s_v_1] = COMBO(s_v_1_combo, KC_ENT),
  [COMBO_s_v_2] = COMBO(s_v_2_combo, KC_ENT),
  ...
  [COMBO_u_n_1] = COMBO(u_n_1_combo, KC_F7),
  [COMBO_u_n_2] = COMBO(u_n_2_combo, KC_F7),
  [COMBO_u_y_1] = COMBO_ACTION(u_y_1_combo),
  [COMBO_u_y_2] = COMBO_ACTION(u_y_2_combo),
  [COMBO_v_b_1] = COMBO(v_b_1_combo, KC_VOLD),
  [COMBO_v_b_2] = COMBO(v_b_2_combo, KC_VOLD),
  [COMBO_w_a_1] = COMBO(w_a_1_combo, KC_F1),
  [COMBO_w_a_2] = COMBO(w_a_2_combo, KC_F1),
  [COMBO_w_f_1] = COMBO(w_f_1_combo, KC_ESC),
  [COMBO_w_f_2] = COMBO(w_f_2_combo, KC_ESC),
  [COMBO_w_f_p_1] = COMBO(w_f_p_1_combo, KC_PGUP),
  [COMBO_w_f_p_2] = COMBO(w_f_p_2_combo, KC_PGUP),
  [COMBO_w_p_1] = COMBO_ACTION(w_p_1_combo),
  [COMBO_w_p_2] = COMBO_ACTION(w_p_2_combo),
  ...
  [COMBO_x_c_v_1] = COMBO(x_c_v_1_combo, KC_PGDN),
  [COMBO_x_c_v_2] = COMBO(x_c_v_2_combo, KC_PGDN),
  [COMBO_x_v_1] = COMBO_ACTION(x_v_1_combo),
  [COMBO_x_v_2] = COMBO_ACTION(x_v_2_combo),
  [COMBO_y_e_1] = COMBO(y_e_1_combo, KC_F8),
  [COMBO_y_e_2] = COMBO(y_e_2_combo, KC_F8),
  [COMBO_y_excl_1] = COMBO(y_excl_1_combo, KC_BRIU),
  [COMBO_y_excl_2] = COMBO(y_excl_2_combo, KC_BRIU),
  [COMBO_y_i_1] = COMBO_ACTION(y_i_1_combo),
  [COMBO_y_i_2] = COMBO_ACTION(y_i_2_combo),
  [COMBO_z_x_1] = COMBO_ACTION(z_x_1_combo),
  [COMBO_z_x_2] = COMBO_ACTION(z_x_2_combo),
...
void process_combo_event(uint8_t combo_index, bool p) {
  switch(combo_index) {
    ...
    case COMBO_coma_dot_1: if (p) {SEND_STRING(SS_TAP(X_END)SS_TAP(X_ENT));}  break;
    case COMBO_coma_dot_2: if (p) {SEND_STRING(SS_TAP(X_END)SS_TAP(X_ENT));}  break;
    case COMBO_g_d_1: if (p) {SEND_STRING(SS_DOWN(X_LCTL)SS_DOWN(X_DEL));} else {SEND_STRING(SS_UP(X_DEL)SS_UP(X_LCTL));} break;
    case COMBO_g_d_2: if (p) {SEND_STRING(SS_DOWN(X_LCTL)SS_DOWN(X_DEL));} else {SEND_STRING(SS_UP(X_DEL)SS_UP(X_LCTL));} break;
    ...
    case COMBO_h_o_1: if (p) {SEND_STRING(SS_TAP(X_END) SS_DOWN(X_LSFT)SS_TAP(X_HOME)SS_UP(X_LSFT) SS_TAP(X_DEL));}  break;
    case COMBO_h_o_2: if (p) {SEND_STRING(SS_TAP(X_END) SS_DOWN(X_LSFT)SS_TAP(X_HOME)SS_UP(X_LSFT) SS_TAP(X_DEL));}  break;
    ...
    case COMBO_l_u_1: if (p) {SEND_STRING(SS_TAP(X_END)SS_DOWN(X_LSFT)SS_TAP(X_HOME)SS_UP(X_LSFT)SS_TAP(X_BSPC)SS_TAP(X_BSPC));}  break;
    case COMBO_l_u_2: if (p) {SEND_STRING(SS_TAP(X_END)SS_DOWN(X_LSFT)SS_TAP(X_HOME)SS_UP(X_LSFT)SS_TAP(X_BSPC)SS_TAP(X_BSPC));}  break;
    ...
    case COMBO_l_y_1: if (p) {SEND_STRING(SS_TAP(X_HOME)SS_TAP(X_BSPC));}  break;
    case COMBO_l_y_2: if (p) {SEND_STRING(SS_TAP(X_HOME)SS_TAP(X_BSPC));}  break;
    case COMBO_m_coma_1: if (p) {SEND_STRING(SS_TAP(X_END)SS_DOWN(X_LSFT)SS_TAP(X_HOME)SS_UP(X_LSFT)SS_TAP(X_DEL)SS_TAP(X_DEL));}  break;
    case COMBO_m_coma_2: if (p) {SEND_STRING(SS_TAP(X_END)SS_DOWN(X_LSFT)SS_TAP(X_HOME)SS_UP(X_LSFT)SS_TAP(X_DEL)SS_TAP(X_DEL));}  break;
    ...
    case COMBO_m_dot_1: if (p) {SEND_STRING(SS_TAP(X_END)SS_TAP(X_DEL));}  break;
    case COMBO_m_dot_2: if (p) {SEND_STRING(SS_TAP(X_END)SS_TAP(X_DEL));}  break;
    case COMBO_n_e_i_o_1: if (p) {SEND_STRING(SS_LCTL("a"));}  break;
    case COMBO_n_e_i_o_2: if (p) {SEND_STRING(SS_LCTL("a"));}  break;
    ...
    case COMBO_r_z_1: if (p) {SEND_STRING(SS_LCTL("z"));}  break;
    case COMBO_r_z_2: if (p) {SEND_STRING(SS_LCTL("z"));}  break;
    ...
    case COMBO_u_y_1: if (p) {SEND_STRING(SS_TAP(X_HOME)SS_TAP(X_ENT)SS_TAP(X_RGHT));}  break;
    case COMBO_u_y_2: if (p) {SEND_STRING(SS_TAP(X_HOME)SS_TAP(X_ENT)SS_TAP(X_RGHT));}  break;
    case COMBO_w_p_1: if (p) {SEND_STRING(SS_DOWN(X_LCTL)SS_TAP(X_HOME)SS_UP(X_LCTL));}  break;
    case COMBO_w_p_2: if (p) {SEND_STRING(SS_DOWN(X_LCTL)SS_TAP(X_HOME)SS_UP(X_LCTL));}  break;
    ...
    case COMBO_x_v_1: if (p) {SEND_STRING(SS_DOWN(X_LCTL)SS_TAP(X_END)SS_UP(X_LCTL));}  break;
    case COMBO_x_v_2: if (p) {SEND_STRING(SS_DOWN(X_LCTL)SS_TAP(X_END)SS_UP(X_LCTL));}  break;
    ...
    case COMBO_z_x_1: if (p) {SEND_STRING(SS_LCTL("x"));}  break;
    case COMBO_z_x_2: if (p) {SEND_STRING(SS_LCTL("x"));}  break;
